...
export const ResultDisplay = () => {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center max-w-[1400px] mx-auto px-6 py-4">
      ...
      <div className="flex lg:hidden flex-col justify-center items-center gap-10">
        {/* Ảnh */}
        <div className="flex flex-col items-center">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSzw1PTnLXyZDfg798W3WgV9rCEWHBU02gUmw&s"
            alt="ECG Image"
            className="w-[280px] h-auto border-2 border-gray-300 rounded-lg shadow-md"
          />
        </div>
