...
import { SymptomResult } from "./ResultDislaySymptom";
import { useSearchParams } from "react-router-dom";

export const HeartSymptomAnalyzeList = () => {
  ...
  return (
    <div className="min-w-screen max-w-[1400px] mx-auto px-4 sm:px-6 py-6 ">
      ...
      {/* Nội dung */}
      <SymptomResult keyword={keyword} status={statusFilter} />
    </div>
  );
};
