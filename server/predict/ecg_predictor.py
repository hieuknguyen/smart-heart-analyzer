...
class ECGPredictor:
    def __init__(self, pca_path=None, model_path=None):
        ...
        self.pca_path = pca_path or r"D:\TTTN_HKI2526\smart-heart-analyzer\models\ecg-image-classification-model\PCA_ECG.pkl"
        self.model_path = model_path or r"D:\TTTN_HKI2526\smart-heart-analyzer\models\ecg-image-classification-model\Heart_Disease_Prediction_using_ECG.pkl"
        self.pca_model = None
        self.ecg_model = None
